 ...
 */
#define VAL_GPIOH_MODER             (PIN_MODE_INPUT(GPIOH_MCU_CLK) |        \
...
#define VAL_GPIOH_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOH_MCU_CLK) |    \
...
#define VAL_GPIOH_OSPEEDR           (PIN_OSPEED_100M(GPIOH_MCU_CLK) |       \
...
#define VAL_GPIOH_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOH_MCU_CLK) |    \
...
#define VAL_GPIOH_ODR               (PIN_ODR_HIGH(GPIOH_MCU_CLK) |          \
...
#define VAL_GPIOH_AFRL              (PIN_AFIO_AF(GPIOH_MCU_CLK, 0) |        \
