...
DDEFS = -DMODULE_NAME="\"$(MODULE_NAME)\"" -DPORT_INT_REQUIRED_STACK=128
...
UDEFS += -DR2MW_TEST -DR2P_USE_BOOTLOADER=0 -DR2P_USE_BRIDGE_MODE=0 -DR2P_ITERATE_PUBSUB=1
